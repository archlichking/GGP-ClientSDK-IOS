...
//@@@WALLETENHANCEMENTBEGIN
    NSString* purchase = NSLocalizedStringWithDefaultValue(@"rootController.purchaseCell.label", @"GreeShowCase", [NSBundle mainBundle], @"Purchase", @"purchase cell title");
//@@@WALLETENHANCEMENTENDS
    ...
    [self addCellWithTitle:requests controllerName:NSStringFromClass([RequestBaseViewController class]) nibName:nil image:[UIImage imageNamed:@"icn_root_requests.png"]];
...
//@@@WALLETENHANCEMENTBEGIN
    [self addCellWithTitle:purchase controllerName:NSStringFromClass([PurchaseViewController class]) nibName:nil image:[UIImage imageNamed:@"icn_root_purchase.png"]];
//@@@WALLETENHANCEMENTENDS
  }
