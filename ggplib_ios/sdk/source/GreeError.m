...
+ (NSError*)localizedGreeErrorWithCode:(NSInteger)errorCode userInfo:(NSDictionary *)userInfo
{
  ...
  if(!localizationTable) {
    ...
    DEFINELOCALIZATION(GreeWalletDepositErrorCodeProductListNotReady, GreePlatformString(@"errorHandling.depositTransactionProductListNotReady.message", @"The product list has not yet been received."));
