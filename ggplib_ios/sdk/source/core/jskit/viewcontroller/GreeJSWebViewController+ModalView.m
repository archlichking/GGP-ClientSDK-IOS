...
@interface GreeJSWebViewController (ModalViewInternal)
- (void)lockUI;
- (void)unlockUI;
@end
...
- (void)lockUI
{
  ...
  [self.inputViewController setUserInteractionEnabled:NO];
}

- (void)unlockUI
{
  [self.inputViewController hideIndicator];
  [self.inputViewController setUserInteractionEnabled:YES];
}
