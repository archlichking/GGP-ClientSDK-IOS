...
- (void)updateTextCounter
{
  ...
  label.text = [[NSNumber numberWithUnsignedInteger:[self textLength]] stringValue];
...
- (void)setUserInteractionEnabled:(BOOL)bool_
{
  self.navigationItem.rightBarButtonItem.enabled = bool_;
  self.navigationItem.leftBarButtonItem.enabled = bool_;
  self.toolbar.userInteractionEnabled = bool_;
  
  // Want to do 
  //   self.textView.editable = bool_;
