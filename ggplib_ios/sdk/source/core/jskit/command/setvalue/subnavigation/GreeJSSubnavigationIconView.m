...
static float const kLabelHeight               = kSubnavigationIconLabelFontSize + 2.0f;
...
- (id)initWithNormalImage:(UIImage*)normalImage
  ...
  if (self)
  {
   ...
   _label.font = [UIFont fontWithName:kSubnavigationIconLabelFont size:kSubnavigationIconLabelFontSize];
...
- (void)layoutSubviews
{
  ...
  if (UIInterfaceOrientationIsPortrait(orientation)) {
    ...
    CGSize textSize = [_label.text sizeWithFont:[UIFont fontWithName:kSubnavigationIconLabelFont size:kSubnavigationIconLabelFontSize]
