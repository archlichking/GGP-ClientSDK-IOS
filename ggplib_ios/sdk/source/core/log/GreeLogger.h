...
@property (nonatomic, retain) NSMutableArray* fileLogLevelList;
@property (nonatomic, assign) NSInteger fileCount;
@property (nonatomic, retain) NSMutableArray* fileIdList;
@property (nonatomic, assign) NSMutableArray* logToFileList;
@property (nonatomic, assign) NSInteger internalSettingsLogLevel;
