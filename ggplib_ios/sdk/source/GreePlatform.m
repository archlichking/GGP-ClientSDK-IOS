...
@property (nonatomic, retain) __block GreeBadgeValues *badgeValues;
  ...
  delegate:(id<GreePlatformDelegate>)delegate
{
  ...
  if (self !=  nil) {
    ...
    if ([_settings boolValueForSetting:GreeSettingEnableLogging]) {
      ...
      _logger.level = level;
      _logger.internalSettingsLogLevel = level;
    ...
    NSDictionary *greeSDKJSSommandsDictionary = [NSDictionary dictionaryWithObjectsAndKeys:
      ...
      [GreeJSRegisterLocalNotificationTimerCommand class], [GreeJSRegisterLocalNotificationTimerCommand name],
      [GreeJSCancelLocalNotificationTimerCommand class], [GreeJSCancelLocalNotificationTimerCommand name],
      [GreeJSSetLocalNotificationEnabledCommand class], [GreeJSSetLocalNotificationEnabledCommand name],
      [GreeJSGetLocalNotificationEnabledCommand class], [GreeJSGetLocalNotificationEnabledCommand name],
      ...
      [GreeJSStartLogAdditionalFileCommand class], [GreeJSStartLogAdditionalFileCommand name],
      [GreeJSStopLogWritingFileCommand class], [GreeJSStopLogWritingFileCommand name],
      nil];
...
+ (void)initializeWithApplicationId:(NSString*)applicationId
  ...
  launchOptions:(NSDictionary*)launchOptions;
{
  [GreePlatform initializeWithApplicationId:applicationId
    consumerKey:consumerKey
    consumerSecret:consumerSecret
    settings:settings
    delegate:delegate];

  sSharedSDKInstance.authorization.launchOptions = launchOptions;
}
...
- (void)updateBootstrapSettingsWithAttemptNumber:(NSInteger)attemptNumber statusBlock:(BOOL(^)(BOOL didSucceed))statusBlock
{
  ...
  [self.httpsClient
    ...
    path:path
    parameters:nil
    success:^(GreeAFHTTPRequestOperation* operation, NSDictionary* settings) {
